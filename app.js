...
/* NEWS_DATA_START */
const NEWS_UPDATED = '2026-07-31';
const NEWS_ITEMS = [
  // ===== 百度热搜 =====
  { plat: '百度', title: '中共中央政治局第二十七次集体学习', summary: '7月30日下午中央政治局就高质量推进国防和军队现代化举行第二十七次集体学习，习近平向全军指战员致以八一建军节祝贺。' },
  { plat: '百度', title: '地球正在发烧 50°C高温来了', summary: '世界气象组织《2025年全球气候状况报告》指出，2015至2025年是有记录以来最热的11年，高温正变得更广泛更频繁。' },
  { plat: '百度', title: '清华求真书院预科班部分学生被清退', summary: '清华大学求真书院2026级预科班部分学生因未通过考核被清退，该预科班属丘成桐数学科学领军人才培养计划环节。' },
  { plat: '百度', title: '超60城优化公积金政策', summary: '今年《政府工作报告》提出深化住房公积金制度改革，上半年已有超过60个城市密集调整优化住房公积金相关政策。' },
  { plat: '百度', title: '文旅靠擦边挣钱 别脏了青山绿水', summary: '贵州贵定洛北河漂流景区“伴漂”服务引发争议，联合调查正在推进，舆论呼吁厘清同类业态规则红线、推动行业规范。' },
  { plat: '百度', title: '资产上亿夫妇被羁押后多家企业倒闭', summary: '河南新蔡企业家王飞与妻子刘素敏2023年因涉嫌诈骗被带走，其年产值超6000万元的多家企业在二人被羁押后相继倒闭。' },
  { plat: '百度', title: '于正回应《凤囚凰》争议', summary: '7月31日于正发文回应争议，称《凤囚凰》是自己探索期不太满意的作品，责任全在自己，希望网友不要迁怒演员。' },
  { plat: '百度', title: '00后姑娘在高考结束后剃了光头', summary: '浙江丽水遂昌高三女生黄可依高考结束后剃光头捐出多年蓄起的长发，用这份特别的成人礼帮助有需要的人，获全网点赞。' },
  { plat: '百度', title: '老人捡空瓶再灌水兜售“假矿泉水”', summary: '上海一名八旬老太疑似捡拾空瓶灌自来水冒充矿泉水售卖，城管表示老人卖水三十多年且一劝就躺地，执法颇为棘手。' },
  { plat: '百度', title: '吴宜泽vs特鲁姆普', summary: '中国斯诺克小将吴宜泽对阵世界名将特鲁姆普的比赛引发关注，中国新生代球员与顶尖强手的对决成为球迷热议焦点。' },
  { plat: '百度', title: '不是高温日就不会中暑？不实', summary: '7月科学流言榜发布，专家澄清并非只有高温日才会中暑，湿度大、通风差等条件下即使气温不高也存在中暑风险。' },
  { plat: '百度', title: '8000米高峰雪崩 10人登山队失联', summary: '当地时间7月30日，著名登山家尼尔马尔·普尔贾一行10人在巴基斯坦布洛德峰遭遇雪崩后失联，救援与搜寻正在进行。' },
  { plat: '百度', title: '数千移民游泳偷渡 西班牙边境崩溃', summary: '数千名移民从摩洛哥游泳前往西班牙北非飞地休达，至少9人在途中丧生，当地国民警卫队称边境管控已濒临崩溃。' },
  { plat: '百度', title: '开学三件套卖不动了？有老板愁坏', summary: '杭州百脑汇等卖场反映，今年电脑手机等“开学三件套”价格接连上涨、销量遇冷，不少数码商家为库存和生意发愁。' },
  { plat: '百度', title: '男子穿拖鞋夜钓被黄辣丁扎穿鞋底', summary: '7月28日四川一男子穿拖鞋夜钓时被黄辣丁硬刺扎穿鞋底伤及脚部，该鱼背鳍胸鳍带毒，刺伤后疼痛剧烈需及时处理。' },
  // ===== 微博热搜 =====
  { plat: '微博', title: 'C罗晒与16岁儿子肌肉合照', summary: 'C罗在社交平台晒出与16岁长子的健身合照，父子俩身材线条相似度引发大量讨论，网友直呼基因和自律都太强。' },
  { plat: '微博', title: '百花奖盛典', summary: '大众电影百花奖盛典举行，多位电影人红毯亮相与获奖名单成为焦点，相关话题在社交平台持续发酵引发观众热议。' },
  { plat: '微博', title: '读懂好感度攀升背后的中国魅力', summary: '多项国际调查显示外界对中国好感度上升，媒体从开放政策、文旅体验与科技产品等角度解读中国魅力提升的原因。' },
  { plat: '微博', title: '突然发现朋友月薪五万', summary: '网友分享得知身边朋友月薪五万后的心理落差，话题引出关于收入差距、职业选择与同辈压力的广泛共鸣与讨论。' },
  { plat: '微博', title: '一直对月薪4千没概念直到换成天', summary: '有网友把月薪4千折算成每天约130元，直观换算让不少人重新感知收入水平，引发关于生活成本的热烈讨论。' },
  { plat: '微博', title: '张雅琪送客人孔明锁', summary: '综艺节目中张雅琪给客人赠送孔明锁作为伴手礼，这份带有传统手工巧思的小礼物获得观众好评并登上热搜。' },
  { plat: '微博', title: '李晟十日终焉领口带血', summary: '剧集《十日终焉》相关片段中李晟角色领口带血的细节被观众捕捉，引发对剧情走向与人物命运的密集猜测。' },
  { plat: '微博', title: '油价调整引发关注', summary: '新一轮成品油价格调整窗口开启，涨跌幅度直接影响车主加油成本，相关话题登上热搜引发广泛关注和讨论。' },
  { plat: '微博', title: '攒了一年钱买的自行车没骑就走了', summary: '网友讲述攒了一年钱买的自行车还没怎么骑就被偷走的经历，帖子引来众多有类似遭遇者共鸣与防盗经验分享。' },
  { plat: '微博', title: 'DeepSeekV4Flash正式版上线', summary: 'DeepSeek推出V4 Flash正式版模型，主打更快响应与更低成本，AI从业者与用户围绕其实际表现展开讨论。' },
  { plat: '微博', title: '消防员劳务派遣问题引热议', summary: '有关部分消防员采用劳务派遣用工方式的讨论登上热搜，公众关注一线救援人员的编制保障与职业权益问题。' },
  { plat: '微博', title: '虞书欣大腿淤青', summary: '虞书欣被拍到腿部有明显淤青，粉丝心疼其拍戏或舞台排练中受伤，敬业话题与健康关切同时引发讨论。' },
  { plat: '微博', title: '连云港火灾消防救援', summary: '江苏连云港发生火灾，消防人员迅速到场处置，现场救援情况与人员安危牵动网友关注，官方通报受到关注。' },
  { plat: '微博', title: '7月A股收官', summary: '7月最后一个交易日A股收官，全月主要指数表现与板块轮动情况成为投资者复盘焦点，后市走向引发讨论。' },
];
/* NEWS_DATA_END */
